...
curdata <- curdata %>% mutate(nr= if_else(answer == 3, nr/2, as.double(nr)))
curdata <- curdata %>% mutate(question = case_match(question, 
                                                    "QU05_01" ~ "(4A) The tool emphasizes what is special or unique in the data.",
                                                    "QU05_02" ~ "(4B) The tool distinguishes positive and negative contributions of features.",
                                                    "QU05_03" ~ "(4C) The tool offers an easily interpretable summary of the features",
                                                    "QU05_04" ~ "(4D) The tool helps me validate if I can trust the shown results.",
                                                    "QU06_04" ~ "(5A) The charts provided by the tool are easy to interpret.",
                                                    "QU06_05" ~ "(5B) The charts provided by the tool are visually pleasing.",
                                                    "QU06_06" ~ "(5C) The charts provided by the tool are helpful for finding feature interactions.",
                                                    "QU06_07" ~ "(5D)  The charts provided by the tool are helpful for interpreting feature interactions."))
...
curdata <- curdata %>% mutate(nr= if_else(answer == 3, nr/2, as.double(nr)))
curdata <- curdata %>% mutate(question = case_match(question, 
                                                    "QE01_01" ~ "(2A) From the explanation, I understand how the model works.",
                                                    "QE01_02" ~ "(2B) This explanation of how the model works is satisfying.",
                                                    "QE01_03" ~ "(2C) This explanation of how the model works has sufficient detail.",
                                                    "QE01_04" ~ "(2D) This explanation seems complete.",
                                                    "QE01_05" ~ "(2E) This explanation shows me how accurate the model is.",
                                                    "QE01_06" ~ "(2F) This explanation shows me how reliable the model is.",
                                                    "QE01_07" ~ "(2G) This explanation tells me how to use the model.",
                                                    "QE01_08" ~ "(2H) This explanation is useful to my goals.",
                                                    "QE01_09" ~ "(2I) This explanation helps me know when I should trust and not trust the model."))
...
ggplot(curdata, aes(x="", y=nr, fill=answer)) + 
 ...
 # geom_label(data=curdata %>% filter(answer %in% c(3,4,5)), aes(y=nr*1.5, label=nr))+
  ...
  theme(legend.justification ="center")
  ggsave("images/ESG.jpg", height=8.5, width=8)
